...
from kfx.schema.validators import null_check_validator, uuid_validator

# Bounds on body-transported global variables. Keys are intentionally liberal
# (the Ketos UI accepts lowercase, digits, underscore, hyphen, and spaces);
...
class WorkflowExecutionRequest(BaseModel):
    ...
    globals: dict[GlobalVarKey, GlobalVarValue] = Field(
        ...
        description=(
            ...
            "legacy ``X-KETOS-GLOBAL-VAR-*`` headers."
        ),
    )
