...
from kfx.base.compressors.model import LCCompressorComponent
from kfx.field_typing import BaseDocumentCompressor
from kfx.inputs.inputs import SecretStrInput
from kfx.io import DropdownInput, StrInput
