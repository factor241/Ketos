...
from kfx.base.composio.safe_provider import SafeLangchainProvider, _sanitize_schema
from kfx.base.mcp.util import create_input_schema_from_json_schema
...
from kfx.io.schema import flatten_schema, schema_to_ketos_inputs
...
class ComposioBaseComponent(Component):
    ...
    def _validate_schema_inputs(self, action_key: str) -> list[InputTypes]:
        """Convert the JSON schema for *action_key* into Ketos input objects."""
        ...
        try:
            ...
            # Additional safety check before calling schema_to_ketos_inputs
            ...
            result = schema_to_ketos_inputs(input_schema)
    ...
    def execute_action(self):
        ...
        try:
            ...
            for field in param_fields:
                ...
                # Coerce Ketos rich types to primitives the Composio API can serialise.
