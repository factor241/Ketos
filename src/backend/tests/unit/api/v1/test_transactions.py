...
from ketos.services.database.models.transactions.crud import (
    transform_transaction_table,
    transform_transaction_table_for_logs,
)
from ketos.services.database.models.transactions.model import (
    TransactionBase,
...
class TestSanitizeData:
    ...
    def test_sanitize_data_masks_api_key(self):
        ...
        data = {"api_key": "REDACTED_OPENAI_API_KEY"}
