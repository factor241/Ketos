...
from kfx.components.models_and_agents.agent_helpers.graph_event_adapter import (
    adapt_graph_events_to_executor_shape,
)
from kfx.components.models_and_agents.agent_helpers.messages_input_builder import (
    build_initial_messages,
)
from kfx.components.models_and_agents.agent_helpers.placeholder_corrective_middleware import (
    WatsonXPlaceholderMiddleware,
)
from kfx.components.models_and_agents.agent_helpers.single_tool_call_middleware import (
    SingleToolCallMiddleware,
)
from kfx.components.models_and_agents.memory import MemoryComponent, aget_agent_chat_history

if TYPE_CHECKING:
    from langchain_core.tools import Tool

    from kfx.schema.log import OnTokenFunctionType, SendMessageFunctionType

from kfx.base.agents.agent import LCToolsAgentComponent
from kfx.base.agents.callback import AgentAsyncHandler
from kfx.base.agents.default_system_prompt import DEFAULT_SYSTEM_PROMPT_TEMPLATE
from kfx.base.agents.events import ExceptionWithMessageError, process_agent_events
from kfx.base.agents.token_callback import TokenUsageCallbackHandler
from kfx.base.agents.utils import get_chat_output_sender_name
from kfx.base.constants import STREAM_INFO_TEXT
from kfx.base.models.unified_models import (
    get_language_model_options,
    get_llm,
    handle_model_input_update,
)
from kfx.base.models.watsonx_constants import IBM_WATSONX_URLS
from kfx.components.agentics.helpers.model_config import validate_model_selection
from kfx.components.helpers import CalculatorComponent, CurrentDateComponent
from kfx.components.langchain_utilities.ibm_granite_handler import is_watsonx_model
from kfx.components.langchain_utilities.tool_calling import ToolCallingAgentComponent
from kfx.custom.custom_component.component import get_component_toolkit
from kfx.field_typing.range_spec import RangeSpec
from kfx.inputs.inputs import BoolInput, DropdownInput, ModelInput, StrInput
from kfx.io import IntInput, MessageTextInput, MultilineInput, Output, SecretStrInput, TableInput
from kfx.log.logger import logger
from kfx.memory import delete_message
...
from kfx.schema.table import EditMode
...
class AgentComponent(ToolCallingAgentComponent):
    ...
    documentation: str = "https://docs.ketos.test/agents"
    icon = "bot"
    beta = False
    name = "Agent"
    ...
    async def run_agent(self, agent) -> Message:
        ...
        (in `kfx.base.agents.events`) can be reused unchanged.
        """
        ...
        # Stream tokens to the event manager when running inside the Ketos runtime.
    ...
    async def json_response(self) -> Data:
        ...
        """
        from kfx.components.models_and_agents.structured_output.structured_output_orchestrator import (
