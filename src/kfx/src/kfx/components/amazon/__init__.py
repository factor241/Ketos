...
if TYPE_CHECKING:
    from kfx.components.amazon.amazon_bedrock_embedding import AmazonBedrockEmbeddingsComponent
    from kfx.components.amazon.amazon_bedrock_model import AmazonBedrockComponent
    from kfx.components.amazon.s3_bucket_uploader import S3BucketUploaderComponent
