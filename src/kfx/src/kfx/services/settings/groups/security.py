...
class SecuritySettings(BaseModel):
    ...
    """If set to True, Ketos will enable SSRF (Server-Side Request Forgery) protection.
    ...
    Note: KETOS_COMPONENTS_PATH and KETOS_COMPONENTS_INDEX_PATH can be used to define
    ...
    """If set to False, KETOS_COMPONENTS_PATH and KETOS_COMPONENTS_INDEX_PATH will
