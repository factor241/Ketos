...
class VideoFileComponent(BaseFileComponent):
    ...
    icon = "TwelveLabs"
    name = "VideoFile"
    documentation = "https://github.com/twelvelabs-io/twelvelabs-developer-experience/blob/main/integrations/Ketos/TWELVE_LABS_COMPONENTS_README.md"
