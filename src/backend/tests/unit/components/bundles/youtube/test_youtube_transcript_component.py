...
import pytest
from kfx.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("kfx.components.youtube.youtube_transcripts.YouTubeTranscriptApi")
