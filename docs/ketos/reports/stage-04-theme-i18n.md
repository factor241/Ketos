...
- **Проверки (коммит 3).** `pnpm exec vitest run packages/client/ui-board/tests` — 10 файлов, 66 passed (включая 6 юнитов `elideMiddlePath` и компонентный тест чипа пути); живой аудит и GIF — ниже.
