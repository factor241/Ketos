...
"""Slot for loose KETOS_COMPONENTS_PATH directories (ad-hoc local dev)."""
...
class LoadedComponent:
    ...
    folders from ``KETOS_COMPONENTS_PATH``, never pip-installed. The
    ...
    *before* the package gets installed (the ``extension dev`` flow);
    ...
    package; ``None`` for inline KETOS_COMPONENTS_PATH bundles AND for
