...
_ENCRYPT_TARGET = "ketos.services.database.models.deployment_provider_account.crud.auth_utils"
_CRUD_LOGGER = "ketos.services.database.models.deployment_provider_account.crud.logger"
