...
description: Refactor high-complexity React components in Langflow frontend. Use when manual complexity assessment exceeds 50 or line count exceeds 300, when the user asks for code splitting, hook extraction, or complexity reduction; avoid simple components, third-party wrappers, or testing-only requests.
---
