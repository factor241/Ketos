...
from ketos.schema.dataframe import DataFrame
from ketos.schema.message import Message
from kfx.base.knowledge_bases import get_knowledge_bases
from kfx.components.files_and_knowledge import KnowledgeIngestionComponent
...
class TestKnowledgeIngestionComponent(ComponentTestBaseWithClient):
    ...
    @patch("kfx.components.files_and_knowledge.knowledge.get_settings_service")
    @patch("kfx.components.files_and_knowledge.knowledge.encrypt_api_key")
    ...
    async def test_convert_df_to_data_objects(self, component_class, default_kwargs):
        ...
        with patch("kfx.components.files_and_knowledge.knowledge.Chroma") as mock_chroma:
    ...
    async def test_convert_df_to_data_objects_no_duplicates(self, component_class, default_kwargs):
        ...
        with patch("kfx.components.files_and_knowledge.knowledge.Chroma") as mock_chroma:
            ...
            with patch("kfx.components.files_and_knowledge.knowledge.hashlib.sha256") as mock_hash:
    ...
    @patch("kfx.components.files_and_knowledge.knowledge.get_embeddings")
    ...
    @patch("kfx.components.files_and_knowledge.knowledge.get_embedding_model_options")
    @patch("kfx.components.files_and_knowledge.knowledge.get_embeddings")
