...
from kfx.services.auth.base import BaseAuthService
from kfx.services.settings.constants import DEFAULT_SUPERUSER, LEGACY_DEFAULT_SUPERUSER_PASSWORD
from sqlalchemy.exc import IntegrityError

from ketos.helpers.user import get_user_by_flow_id_or_endpoint_name
from ketos.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_SESSION_WARNING, AUTO_LOGIN_WARNING
...
from ketos.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default Ketos authentication service (implements KFX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        from ketos.services.auth.utils import ACCESS_TOKEN_TYPE, get_jwt_verification_key
