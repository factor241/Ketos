"""Lightweight tracing service for KFX package."""
...
from kfx.services.tracing.base import BaseTracingService
...
class TracingService(BaseTracingService):
    """Minimal tracing service implementation for KFX.
    ...
    async def start_tracers(
        ...
        Args:
            ...
            run_name: Run name
            user_id: Authenticated Ketos user identifier
