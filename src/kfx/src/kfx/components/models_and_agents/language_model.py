...
from kfx.components.models_and_agents.model_selection import apply_model_overrides
from kfx.field_typing.constants import LanguageModel
from kfx.field_typing.range_spec import RangeSpec
from kfx.inputs.inputs import BoolInput, DropdownInput, StrInput
from kfx.io import IntInput, MessageInput, ModelInput, MultilineInput, SecretStrInput, SliderInput
...
class LanguageModelComponent(LCModelComponent):
    ...
    documentation: str = "https://docs.ketos.test/components-models"
    icon = "brain-circuit"
    category = "models"
