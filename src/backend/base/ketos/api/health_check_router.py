...
from ketos.services.deps import get_chat_service
...
# it means uvicorn's /health serves first before the ketos instance is up
# therefore it's not a reliable health check for a ketos instance
...
# It's a reliable health check for a ketos instance
