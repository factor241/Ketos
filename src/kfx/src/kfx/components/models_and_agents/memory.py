...
from kfx.helpers.data import data_to_text
from kfx.inputs.inputs import DropdownInput, HandleInput, IntInput, MessageTextInput, MultilineInput, TabInput
from kfx.log.logger import logger
from kfx.memory import aget_messages, astore_message
...
from kfx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_USER
...
class MemoryComponent(Component):
    ...
    description = "Stores or retrieves stored chat messages from Ketos tables or an external memory."
    documentation: str = "https://docs.ketos.test/message-history"
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="Retrieve messages from an external memory. If empty, it will use the Ketos tables.",
            advanced=True,
        ),
        DropdownInput(
            name="sender_type",
