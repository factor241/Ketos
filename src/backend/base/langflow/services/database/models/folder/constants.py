...
DEFAULT_FOLDER_DISPLAY_NAME = "Starter Project"
DEFAULT_FOLDER_NAME = os.getenv("DEFAULT_FOLDER_NAME", DEFAULT_FOLDER_DISPLAY_NAME)
DEFAULT_FOLDER_NAME_I18N_KEY = "system_folders.default.name"
