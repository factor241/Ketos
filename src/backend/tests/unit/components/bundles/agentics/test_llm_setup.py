...
class TestPrepareLlmFromComponent:
    ...
    @patch("kfx.components.agentics.helpers.llm_setup.create_llm")
    @patch("kfx.components.agentics.helpers.llm_setup.get_api_key_for_provider")
    @patch("kfx.components.agentics.helpers.llm_setup.validate_model_selection")
