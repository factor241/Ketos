"""Service dependency functions for kfx package."""
...
from kfx.services.config_discovery import resolve_config_dir
...
if TYPE_CHECKING:
    ...
    from kfx.services.adapters.registry import AdapterRegistry
    from kfx.services.interfaces import (
        AuthServiceProtocol,
...
def get_db_service() -> DatabaseServiceProtocol:
    ...
    if db_service is None:
        ...
        # This allows kfx to work in standalone mode without requiring database setup
...
def get_shared_component_cache_service() -> CacheServiceProtocol | None:
    ...
    from kfx.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_extension_events_service():
    ...
    """
    from kfx.services.extension_events.factory import ExtensionEventsServiceFactory
...
def get_auth_service() -> AuthServiceProtocol | None:
    ...
    Returns the pluggable auth service (minimal KFX or full Ketos when configured).
    """
    from kfx.services.schema import ServiceType
...
def _get_deployment_registry() -> AdapterRegistry[DeploymentServiceProtocol]:
    ...
    """
    from kfx.services.adapters.registry import get_adapter_registry
...
def get_deployment_adapter(
    ...
    if instance is None:
        logger.warning(
            ...
            f"Check your kfx.toml or adapter registration."
        )
    return instance
