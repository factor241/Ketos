"""Unit tests for the ketos.helpers.flow module."""
...
_KETOS_HELPER_MODULE_FLOW = "ketos.helpers.flow"
...
class TestDynamicImport:
    """Test dynamic imports of the ketos implementation."""

    def test_ketos_available(self):
        """Test whether the ketos implementation is available."""
        # Ketos implementation should be available
        if not has_ketos_memory():
            pytest.fail("Ketos implementation is not available")
    ...
    def test_helpers_import_build_schema_from_inputs(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(build_schema_from_inputs, _KETOS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_get_arg_names(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(get_arg_names, _KETOS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_get_flow_inputs(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(get_flow_inputs, _KETOS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_list_flows(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(list_flows, _KETOS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_load_flow(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(load_flow, _KETOS_HELPER_MODULE_FLOW)
    ...
    def test_helpers_import_run_flow(self):
        ...
        # Helper module should be the ketos implementation
        assert is_helper_module(run_flow, _KETOS_HELPER_MODULE_FLOW)
