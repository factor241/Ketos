...
from ketos.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from ketos.services.store.schema import (
...
from ketos.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.ketos.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates ketos with the store which is a Directus instance.
