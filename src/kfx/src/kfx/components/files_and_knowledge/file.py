...
- ALL Docling parsing/export runs in a separate OS process to prevent memory
  growth and native library state from impacting the main Ketos process.
...
from kfx.base.data.storage_utils import parse_storage_path, read_file_bytes, validate_image_content_type
from kfx.base.data.utils import TEXT_FILE_TYPES, parallel_load_data, parse_text_file_to_data
from kfx.inputs import SortableListInput
from kfx.inputs.inputs import DropdownInput, MessageTextInput, StrInput
from kfx.io import BoolInput, FileInput, IntInput, Output, SecretStrInput
from kfx.schema.data import Data
from kfx.schema.dataframe import DataFrame  # noqa: TC001
from kfx.schema.message import Message
from kfx.services.deps import get_settings_service, get_storage_service
from kfx.utils.async_helpers import run_until_complete
from kfx.utils.validate_cloud import is_astra_cloud_environment
...
class FileComponent(BaseFileComponent):
    ...
    documentation: str = "https://docs.ketos.test/read-file"
    icon = "file-text"
    name = "File"
    ...
    def _read_from_aws_s3(self) -> list[BaseFileComponent.BaseFile]:
        ...
        from kfx.base.data.cloud_storage_utils import create_s3_client, validate_aws_credentials
    ...
    def _read_from_google_drive(self) -> list[BaseFileComponent.BaseFile]:
        ...
        from kfx.base.data.cloud_storage_utils import create_google_drive_service
