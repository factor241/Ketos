...
from kfx.helpers.data import safe_convert
from kfx.io import BoolInput, DropdownInput, IntInput, MessageTextInput, Output, SliderInput, TableInput
from kfx.log.logger import logger
from kfx.schema.dataframe import DataFrame
from kfx.schema.message import Message
from kfx.utils.request_utils import get_user_agent
from kfx.utils.ssrf_protection import SSRFProtectionError, is_ssrf_protection_enabled, validate_and_resolve_url
from kfx.utils.ssrf_transport import create_ssrf_protected_client
...
USER_AGENT = None
# Check if ketos is installed using importlib.util.find_spec(name))
if importlib.util.find_spec("ketos"):
    ketos_installed = True
    USER_AGENT = get_user_agent()
else:
    ketos_installed = False
    USER_AGENT = "kfx"
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/url"
