...
from ketos.api.utils.mcp.config_utils import validate_mcp_server_for_project
from ketos.api.v1.mcp_projects import get_project_streamable_http_url
from ketos.api.v2.mcp import update_server
from ketos.services.database.models.api_key.crud import create_api_key
from ketos.services.database.models.api_key.model import ApiKeyCreate
from ketos.services.deps import get_service, get_settings_service, get_storage_service
...
def _server_config_has_project_api_key(args: list[Any]) -> bool:
    """Return whether the server args include the generated Ketos API key header."""
    return any(
