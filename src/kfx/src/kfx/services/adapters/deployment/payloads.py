...
from kfx.services.adapters.payload import AdapterPayload, PayloadSlot, ProviderPayloadSchemas
...
class DeploymentPayloadFields(ProviderPayloadSchemas):
    ...
    - Ketos mappers populate ``DeploymentApiPayloads`` (API-side contracts)
    """
