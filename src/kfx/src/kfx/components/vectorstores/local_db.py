...
from kfx.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from kfx.base.vectorstores.user_scoping import runtime_user_id, scoped_collection_name
from kfx.base.vectorstores.utils import chroma_collection_to_data
from kfx.inputs.inputs import MultilineInput
from kfx.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from kfx.services.cache.utils import CACHE_DIR
