...
from ketos.services.database.models.message.model import MessageRead, MessageTable
...
async def aadd_messages(
    ...
    # Check if all messages are Message instances (either from ketos or kfx)
    for message in messages:
        # Accept Message instances from both ketos and kfx packages
