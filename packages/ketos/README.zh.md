...
| Package | Роль |
|---|---|
| [`@ketos/client-locale-ru`](client-locale-ru/README.zh.md) | Пакет русской локали для веб-интерфейса: регистрирует `ru`, переводит общий и settings-словари и ставит `ru` по умолчанию, пока пользователь не сохранил собственную локаль |
