"""Single-Bundle loader for the Ketos Extension System.

This package turns a directory tree on disk (an Extension or a loose
KETOS_COMPONENTS_PATH entry) into a list of :class:`LoadedComponent`
...
Two entry points exist:
    ...
    2. :func:`discover_inline_bundles` -- given a list of KETOS_COMPONENTS_PATH
...
The loader's contract with the rest of the system is:
    ...
    - Failures are typed.  Every error path produces an
      :class:`~kfx.extension.errors.ExtensionError`; nothing raises across
...
from kfx.extension.loader._discovery import DEFAULT_MODULE_NAMESPACE
from kfx.extension.loader._orchestrator import (
