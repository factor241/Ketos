...
from kfx.inputs.inputs import IntInput, MultilineInput, NestedDictInput, SecretStrInput, StrInput
from kfx.io import Output
from kfx.schema.data import Data
from kfx.schema.dataframe import DataFrame
from kfx.utils.ssrf_httpx import ssrf_safe_httpx_post
...
class GleanAPIWrapper(BaseModel):
    ...
    act_as: str = "ketos-component@datastax.com"  # TODO: Detect this
...
class GleanSearchAPIComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.ketos.test/bundles-glean"
    icon: str = "Glean"
