...
class McpSettings(BaseModel):
    ...
    (e.g. 'https://ketos.example.com'). When empty, the frontend falls back to
    ...
    """If set to False, Ketos will not enable the MCP server."""
    mcp_server_enable_progress_notifications: bool = False
    """If set to False, Ketos will not send progress notifications in the MCP server."""
    ...
    """If set to True, Ketos skips the background MCP server auto-initialization on startup.
    ...
    """If set to False, Ketos will not start the MCP Composer service."""
