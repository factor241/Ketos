...
from kfx.base.datastax.astradb_base import AstraDBBaseComponent
...
from kfx.base.vectorstores.vector_store_connection_decorator import vector_store_connection
from kfx.helpers.data import docs_to_data
from kfx.io import (
    BoolInput,
    DropdownInput,
    FloatInput,
...
from kfx.serialization import serialize
...
class AstraDBVectorStoreComponent(AstraDBBaseComponent, LCVectorStoreComponent):
    ...
    documentation: str = "https://docs.ketos.test/bundles-datastax"
    name = "AstraDB"
    icon: str = "AstraDB"
    ...
    def build_vector_store(self):
        ...
        # Get Ketos version and platform information
        ...
        try:
            vector_store = AstraDBVectorStore(
                ...
                ext_callers=[(f"{ketos_prefix}ketos", __version__)],
