...
from kfx.base.memory.model import LCChatMemoryComponent
from kfx.inputs.inputs import DictInput, HandleInput, MessageTextInput, NestedDictInput, SecretStrInput
...
class Mem0MemoryComponent(LCChatMemoryComponent):
    ...
    def build_mem0(self) -> Memory:
        ...
        # serving process (e.g. kfx serve) one caller's key would leak into other
