...
from kfx.base.models.ollama_constants import DEFAULT_OLLAMA_API_URL
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("kfx.components.ollama.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("kfx.components.ollama.ollama.httpx.AsyncClient.post")
    @patch("kfx.components.ollama.ollama.httpx.AsyncClient.get")
    ...
    @patch("kfx.components.ollama.ollama.ChatOllama")
    @patch("kfx.components.ollama.ollama.logger")
    ...
    def test_build_model_with_pydantic_model_json_schema(self, mock_chat_ollama, component_class, default_kwargs):
        ...
        https://github.com/ketos-ai/ketos/issues/7122
        """
    ...
    @pytest.mark.asyncio
    @patch("kfx.components.ollama.ollama.ChatOllamaComponent._parse_json_response")
