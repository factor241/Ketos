...
from kfx.components.processing import ParserComponent
...
""")
    ...
    url_component.set(urls=["https://ketos.test/", "https://docs.ketos.test/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Ketos and AI. "
