...
from kfx.events.observability.lifecycle_events import observable


# Mock classes for dependencies
class MockEventManager:
    """Mock for kfx.events.event_manager.EventManager."""
...
class MockLogger:
    """Mock for kfx.log.logger.logger."""
...
def mock_dependencies():
    ...
    with (
        patch("kfx.events.observability.lifecycle_events.logger", mock_logger_instance),
        patch("kfx.events.observability.lifecycle_events.encoder", mock_encoder_instance),
    ):
        yield {
