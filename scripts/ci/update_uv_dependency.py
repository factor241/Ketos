...
def update_uv_dep(base_version: str) -> None:
    ...
    # Keep the canonical `ketos-base` name with an exact `==<dev>` pin.
    replacement = rf'\1"ketos-base{extras}=={base_version}"'
