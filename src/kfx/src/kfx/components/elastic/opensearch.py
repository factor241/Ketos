...
from kfx.io import BoolInput, DropdownInput, HandleInput, IntInput, MultilineInput, SecretStrInput, StrInput, TableInput
...
class OpenSearchVectorStoreComponent(LCVectorStoreComponent):
    ...
    def search_documents(self) -> list[Data]:
        ...
        configured search_query and returns results in Ketos's Data format.
