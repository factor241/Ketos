...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Root container of the spatial board canvas; renders the floating layers.',
    doc: 'Root container of the spatial board canvas; renders the floating layers.',
    registerOptions: [],
    ownerProps: [],
    ...
    occupants: [
      'client-ui-board DashboardCanvas',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.canvas\', () => ctx.slots.register(\n      { name: \'board.canvas\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:775',
  },
  {
    key: 'board.dock',
    kind: 'single',
    scope: 'root',
    summary: 'Left floating rail showing active sessions / windows.',
    doc: 'Left floating rail showing active sessions / windows.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board SessionRail',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.dock\', () => ctx.slots.register(\n      { name: \'board.dock\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:777',
  },
  {
    key: 'board.minimap',
    kind: 'single',
    scope: 'root',
    summary: 'Bottom-right interactive SVG minimap.',
    doc: 'Bottom-right interactive SVG minimap.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Floating center omnibox.',
    doc: 'Floating center omnibox.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board DashboardToolbar',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.omnibar\', () => ctx.slots.register(\n      { name: \'board.omnibar\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:815',
  },
  {
    key: 'board.window',
    kind: 'keyed',
    ...
    keyDomain: 'fixed by the owner\'s key table { [Key in WindowKind]: BoardWindowOwnerProps }, already taken: agent, clone, connectors, dashboard, settings, tasks',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'board.windows\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board AgentCard key \'agent\'',
      'client-ui-board AgentCard key \'clone\'',
      'client-ui-board WindowFrame key \'connectors\'',
      'client-ui-board WindowFrame key \'settings\'',
      'client-ui-board WindowFrame key \'dashboard\'',
      'client-ui-board WindowFrame key \'tasks\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.window\', () => ctx.slots.register(\n      { name: \'board.window\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:785',
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Key in WindowBodyKind]: BoardWindowBodyOwnerProps }, already taken: clone, clone-memory, conversation, tasks',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'board.windows\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board ConversationBody key \'conversation\'',
      'client-ui-board CloneBody key \'clone\'',
      'client-ui-board CloneMemoryBody key \'clone-memory\'',
      'client-ui-board TasksBody key \'tasks\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.window.body\', () => ctx.slots.register(\n      { name: \'board.window.body\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:796',
  },
  {
    key: 'board.window.panel',
    kind: 'keyed',
    scope: 'root',
    summary: 'Chats panel of one board card: a companion layer the frame\'s own fullscreen toggle expands.',
    doc: 'Chats panel of one board card: a companion layer the frame\'s own fullscreen\ntoggle expands. The keyed table closes the dispatch domain to `WindowKind`.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    keyDomain: 'fixed by the owner\'s key table { [Key in WindowKind]: BoardWindowPanelOwnerProps }, already taken: agent, clone',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'board.windows\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board WindowChatsPanel key \'agent\'',
      'client-ui-board WindowChatsPanel key \'clone\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.window.panel\', () => ctx.slots.register(\n      { name: \'board.window.panel\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:806',
  },
  {
    key: 'board.windows',
    kind: 'single',
    scope: 'root',
    summary: 'Multi-window layer inside the canvas transform; renders the keyed window slots.',
    doc: 'Multi-window layer inside the canvas transform; renders the keyed window slots.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'board.canvas\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board BoardWindowLayer',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'board.windows\', () => ctx.slots.register(\n      { name: \'board.windows\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-board/src/client/contract/slots.ts:779',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: board, conversation',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board BoardRoot key \'board\'',
