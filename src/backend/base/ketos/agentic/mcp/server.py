"""FastMCP server for Ketos Agentic tools.
...
from ketos.agentic.mcp.support import replace_none_and_null_with_empty_str
from ketos.agentic.utils.assistant_runner import run_assistant_and_persist
from ketos.agentic.utils.component_search import (
...
from ketos.agentic.utils.flow_component import (
...
from ketos.agentic.utils.template_create import (
    create_flow_from_template_and_get_link,
)
from ketos.agentic.utils.template_search import (
    get_all_tags,
    get_template_by_id,
    get_templates_count,
    list_templates,
)
from ketos.services.deps import get_db_service, get_settings_service, session_scope
...
async def run_assistant(
    ...
    """Ask the Ketos Assistant to build, edit, or explain a flow.
    ...
    so it is immediately visible in the Ketos UI.
