...
if TYPE_CHECKING:
    ...
    from kfx.components.files_and_knowledge.knowledge import KnowledgeComponent
    from kfx.components.files_and_knowledge.memory_retrieval import MemoryBaseComponent
