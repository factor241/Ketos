"""Framework-agnostic deployment exceptions for KFX deployment service.
...
class DeploymentNotConfiguredError(DeploymentError):
    ...
    The stub :class:`~kfx.services.adapters.deployment.service.DeploymentService` raises
...
def http_status_for_deployment_error(exc: DeploymentServiceError) -> int:
    ...
    Order mirrors the except-chain priority in the Ketos route layer:
