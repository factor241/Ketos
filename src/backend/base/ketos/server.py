...
class KetosUvicornWorker(UvicornWorker):
...
class KetosApplication(BaseApplication):
    def __init__(self, app_factory: Callable[[], Any], options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "ketos.server.KetosUvicornWorker"
    ...
    def load(self):
        if self.application is None:
            ...
            if self.cfg.preload_app:
                from ketos.preload import preload_master
