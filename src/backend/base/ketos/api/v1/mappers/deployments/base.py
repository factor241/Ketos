...
from kfx.services.adapters.deployment.payloads import DeploymentPayloadFields
...
class DeploymentApiPayloads(DeploymentPayloadFields):
    ...
    Ownership boundary:
    Ketos owns API slot population here because API payloads may include
    Ketos-specific references and reshaping requirements. Adapter-side
...
class BaseDeploymentMapper:
    ...
    - Mapper: API-boundary translation/validation (Ketos schemas <-> adapter payloads).
    ...
    Ketos-aware resolution or payload reshaping.
    """
