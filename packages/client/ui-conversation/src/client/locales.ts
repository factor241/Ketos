...
export const en = {
  ...
  'hero.headlines': [
    ...
    'Which idea shall we bring to life?',
    'What comes first?',
    'What shall we dive into?',
    "What's on the agenda today?",
    'Which task shall we take?',
    'What are we solving?',
    'Where do we start the work?',
    ...
    'What needs checking?',
    'Where can help be useful?',
    'What shall we automate?',
    'Which hypothesis shall we test?',
    'What shall we study?',
    ...
    'Which idea shall we pursue?',
    "What's ahead of us?",
    'Where are we heading?',
    'What needs attention?',
    'What shall we bring to life?',
    'What shall we get into?',
    'What shall we prepare?',
    'Which task are we closing?',
    'What starts right now?',
    'What sparks your interest?',
    'Which question shall we unpack?',
  ].join('\n'),
