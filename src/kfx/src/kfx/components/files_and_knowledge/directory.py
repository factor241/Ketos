...
from kfx.base.data.utils import TEXT_FILE_TYPES, parallel_load_data, parse_text_file_to_data, retrieve_file_paths
from kfx.custom.custom_component.component import Component
from kfx.io import BoolInput, IntInput, MessageTextInput, MultiselectInput
...
class DirectoryComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/directory"
    icon = "folder"
    name = "Directory"
    legacy = True
