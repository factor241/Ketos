...
memory issues, and outputs Data objects suitable for feeding into any Ketos
...
from kfx.io import HandleInput, IntInput, Output, StrInput
    ...
    def generate_descriptions(self) -> list[Data]:
        try:
            ...
            script = textwrap.dedent("""\
                ...
                from kfx.base.data.docling_utils import _deserialize_pydantic_model
