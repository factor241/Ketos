...
KETOS_ASSISTANT_FLOW = "KetosAssistant.json"
...
OFF_TOPIC_REFUSAL_MESSAGE = (
    "I appreciate your interest, but I'm the Ketos Assistant and can only help with "
    "Ketos-related topics such as building components, creating flows, configuring "
    "deployments, and troubleshooting issues. Could you rephrase your question about Ketos?"
)
...
FLOW_VERIFICATION_ENABLED_ENV = "KETOS_ASSISTANT_VERIFY_FLOWS"
...
Respond with a complete, valid Ketos component as a Python class extending Component, \
