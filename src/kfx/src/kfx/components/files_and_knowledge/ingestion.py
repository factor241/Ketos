...
:mod:`kfx.components.files_and_knowledge.knowledge` as the mode-driven
...
class KnowledgeIngestionComponent(KnowledgeComponent):
    """Create or append to Ketos Knowledge from a DataFrame.
    ...
    description = "Create or update knowledge in Ketos."
    icon = "upload"
