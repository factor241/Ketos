...
if TYPE_CHECKING:
    from kfx.components.input_output.chat import ChatInput
    ...
    from kfx.components.input_output.text_output import TextOutputComponent
    from kfx.components.input_output.webhook import WebhookComponent
