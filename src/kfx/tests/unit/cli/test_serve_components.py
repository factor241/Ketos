...
from kfx.cli.common import flow_id_from_path, load_graph_from_path, validate_script_path
...
class TestCommonFunctions:
    ...
    @patch("kfx.cli.common.load_flow_from_json")
    @pytest.mark.asyncio
...
def create_real_graph():
    """Helper function to create a real KFX graph with nodes/edges for serve_app."""
...
class TestFastAPIAppCreation:
    ...
    def test_create_multi_serve_app_basic(self):
        ...
        assert app.title.startswith("KFX Multi-Flow Server")
...
class TestFastAPIEndpoints:
    ...
    @patch("kfx.cli.common.execute_graph_with_capture")
    @patch("kfx.cli.common.extract_result_data")
...
class TestIntegration:
    ...
    async def test_full_app_integration(self, mock_load_flow):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as tmp:
            ...
            # Test app creation
            from kfx.cli.serve_app import verify_api_key as _verify_api_key
