...
Why this lives in its own module:
    ...
    that mutates the live ``_kfx_ext.*`` namespace, and
...
:func:`kfx.extension.reload.reload_bundle` for the surrounding pipeline.
"""
...
if TYPE_CHECKING:
    ...
    from kfx.extension.loader import LoadedComponent
