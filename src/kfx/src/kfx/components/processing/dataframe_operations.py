...
from kfx.io import BoolInput, DataFrameInput, DropdownInput, IntInput, MessageTextInput, Output, StrInput
...
class DataFrameOperationsComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/dataframe-operations"
    icon = "table"
