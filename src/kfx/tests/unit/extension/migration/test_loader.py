...
from kfx.extension.migration import loader as loader_mod
...
@pytest.mark.unit
def test_canonical_path_lives_in_kfx_package() -> None:
    """Sanity: the canonical path is inside the kfx wheel layout."""
