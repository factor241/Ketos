"""Initialize services for kfx package."""

from kfx.services.settings.factory import SettingsServiceFactory


def initialize_services():
    """Initialize required services for kfx."""
    ...
    # This allows KFX to use minimal auth/telemetry/tracing/variable when no config overrides.
