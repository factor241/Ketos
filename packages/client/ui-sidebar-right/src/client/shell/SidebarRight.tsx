...
import { IconExitFullscreenCornersOutline16, IconFullscreenCornersOutline16, IconPanelLeftOutline16, Tooltip } from '@deepseek-ai/dsh-client-ui-primitives'
import type {
  ...
  return (
    <>
      <Tooltip label={modeLabel} side="bottom" delayMs={500}>
        ...
        >
          {fullscreen ? <IconExitFullscreenCornersOutline16 /> : <IconFullscreenCornersOutline16 />}
        </button>
      </Tooltip>
