...
from kfx.inputs.inputs import DataFrameInput
from kfx.io import BoolInput, DropdownInput, SecretStrInput, StrInput
from kfx.schema import Data, DataFrame, Message
from kfx.services.deps import get_settings_service, get_storage_service, session_scope
...
class SaveToFileComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/write-file"
    icon = "file-text"
    name = "SaveToFile"
    ...
    def _get_input_type(self) -> str:
        ...
        # pandas DataFrame rather than Ketos's DataFrame wrapper.
    ...
    async def _save_to_aws(self) -> Message:
        ...
        if not bucket_name:
            msg = (
                ...
                "or set KETOS_OBJECT_STORAGE_BUCKET_NAME environment variable."
            )
            raise ValueError(msg)
