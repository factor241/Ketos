...
_FIRST_LINE_EXPECTATIONS: dict[str, str] = {
    ...
    "version-constraint-unsatisfied": "error[version-constraint-unsatisfied]: Manifest at loc declares kfx.compat='content', which does not include this kfx package's BUNDLE_API_VERSION; refusing to load.",  # noqa: E501
    ...
    "duplicate-inline-bundle": "error[duplicate-inline-bundle]: Inline bundle name 'content' appears in multiple KETOS_COMPONENTS_PATH entries; first wins. Locations: loc.",  # noqa: E501
    ...
    "inline-path-missing": "error[inline-path-missing]: KETOS_COMPONENTS_PATH entry 'content' does not exist or is not a directory; skipped.",  # noqa: E501
    "inline-path-unreadable": "error[inline-path-unreadable]: KETOS_COMPONENTS_PATH entry 'content' could not be enumerated: msg",  # noqa: E501
