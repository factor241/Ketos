...
Write-Host "Starting Ketos frontend build process..." -ForegroundColor Green
...
Write-Host "You can now run the backend with: uv run ketos run" -ForegroundColor Cyan
Read-Host "Press Enter to exit"