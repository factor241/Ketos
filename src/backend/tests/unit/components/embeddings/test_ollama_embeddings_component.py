...
class TestOllamaEmbeddingsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("kfx.components.ollama.ollama_embeddings.OllamaEmbeddings")
    ...
    @patch("kfx.components.ollama.ollama_embeddings.OllamaEmbeddings")
    @patch("kfx.components.ollama.ollama_embeddings.logger")
    ...
    @pytest.mark.asyncio
    @patch("kfx.components.ollama.ollama_embeddings.httpx.AsyncClient.post")
    @patch("kfx.components.ollama.ollama_embeddings.httpx.AsyncClient.get")
