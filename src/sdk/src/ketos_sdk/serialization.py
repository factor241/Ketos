"""Git-friendly flow serialization for ketos-sdk.

``normalize_flow`` transforms a raw Ketos flow dict into a stable,
...
def normalize_flow(
    ...
    *,
    ...
    ----------
    flow:
        Raw flow dict as returned by the Ketos API or read from a ``.json``
        file.
    strip_volatile:
