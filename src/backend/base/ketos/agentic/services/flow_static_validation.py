...
Reuses Ketos's existing CLI validator
(``kfx.cli.validation.core.validate_flow_file`` →
...
from kfx.cli.validation.core import LEVEL_REQUIRED_INPUTS, validate_flow_file
...
def _unknown_component_errors(flow: dict[str, Any]) -> list[str]:
    ...
    """
    try:
        from kfx.mcp.flow_builder_tools import _load_registry_user_aware
