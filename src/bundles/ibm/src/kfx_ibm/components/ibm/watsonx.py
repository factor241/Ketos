...
from kfx.base.models.model_utils import get_watsonx_llm_models
from kfx.field_typing import LanguageModel
from kfx.field_typing.range_spec import RangeSpec
from kfx.inputs.inputs import BoolInput, DropdownInput, IntInput, SecretStrInput, SliderInput, StrInput
...
class WatsonxAIComponent(LCModelComponent):
    """KFX component for IBM watsonx.ai text/chat generation."""
    ...
    # bundle's static AST validator (``kfx extension validate``) detects
