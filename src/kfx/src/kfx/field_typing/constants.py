"""Constants for field typing used throughout kfx package."""
...
try:
    ...
    # and crashed `ketos --version` on fresh Windows installs.
    class AgentExecutor:
        pass
...
# Import kfx schema types (avoid circular deps)
from kfx.schema.data import JSON, Data
