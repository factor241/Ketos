...
from kfx.io import MultilineInput, Output, StrInput
from kfx.schema.data import Data
from kfx.utils.python_repl_security import ensure_code_execution_enabled, safe_builtins, validate_code_safety


class PythonREPLComponent(Component):
    display_name = "Python Interpreter"
    description = "Run Python code with optional imports. Use print() to see the output."
    documentation: str = "https://docs.ketos.test/python-interpreter"
