...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    source: 'packages/client/ui-board/src/client/contract/slots.ts:70',
  },
  {
    key: 'board.dock',
    kind: 'single',
    ...
    source: 'packages/client/ui-board/src/client/contract/slots.ts:72',
  },
  {
    key: 'board.minimap',
    kind: 'single',
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Key in WindowBodyKind]: BoardWindowBodyOwnerProps }, already taken: connectors, conversation, settings',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'board.windows\' (client-ui-board), so it exists while that entry is mounted',
    occupants: [
      'client-ui-board ConversationBody key \'conversation\'',
      'client-ui-board ToolWindowBody key \'connectors\'',
      'client-ui-board ToolWindowBody key \'settings\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    source: 'packages/client/ui-board/src/client/contract/slots.ts:74',
  },
  {
