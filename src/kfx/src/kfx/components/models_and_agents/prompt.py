...
from kfx.base.prompts.api_utils import process_prompt_template
from kfx.custom.custom_component.component import Component
from kfx.inputs.input_mixin import FieldTypes
from kfx.inputs.inputs import DefaultPromptField
from kfx.io import BoolInput, MessageTextInput, Output, PromptInput
from kfx.log.logger import logger
from kfx.schema.dotdict import dotdict
from kfx.schema.message import Message
from kfx.template.utils import update_template_values
from kfx.utils.mustache_security import validate_mustache_template


class PromptComponent(Component):
    display_name: str = "Prompt Template"
    description: str = "Create a prompt template with dynamic variables."
    documentation: str = "https://docs.ketos.test/components-prompts"
    icon = "prompts"
    trace_type = "prompt"
