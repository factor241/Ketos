...
from kfx.io import BoolInput, ModelInput, MultilineInput, MultiselectInput, Output, SecretStrInput, SliderInput
from kfx.schema import Data, Message
...
class GuardrailsComponent(Component):
    ...
    documentation = "https://docs.ketos.test/guardrails"
    icon = "shield-check"
