...
from ketos.helpers.flow import get_flow_by_id_or_name
...
# TODO: switch to kfx
from kfx.helpers import get_flow_inputs, run_flow
from kfx.inputs.inputs import BoolInput, DropdownInput, InputTypes, MessageTextInput, StrInput
...
from kfx.services.deps import get_shared_component_cache_service
...
class RunFlowBaseComponent(Component):
    ...
    def _process_tweaks_on_graph(self, graph: Graph, tweaks: dict[str, dict[str, Any]]):
        # there is a bug with the kfx process_tweaks_on_graph function
