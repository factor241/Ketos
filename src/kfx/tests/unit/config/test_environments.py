"""Unit tests for kfx.config.environments — environment resolution.
...
from kfx.config.environments import (
    ConfigError,
    KetosEnvironment,
    _find_config_file,
    _load_config,
...
class TestKetosEnvironment:
    def test_fields_stored(self):
        e = KetosEnvironment(name="staging", url="https://x.com", api_key="key123")  # pragma: allowlist secret
    ...
    def test_api_key_may_be_none(self):
        e = KetosEnvironment(name="local", url="http://localhost:7860", api_key=None)
