...
from ketos.schema.validators import TF_WITH_TZ_AND_MICROSECONDS, str_to_timestamp, str_to_timestamp_validator
...
class MessageTable(MessageBase, table=True):  # type: ignore[call-arg]
    ...
    def _sanitize_json(value):
        ...
        kfx Table instances and numpy scalars) that can leak into ContentBlock
