"""Core component executor for known Ketos components.

Executes known Ketos components by importing them directly by module path,
...
class CoreExecutor(BaseExecutor):
    """Executes known Ketos components by importing them directly.
    ...
    async def execute(
        ...
        """Execute a core Ketos component.

        Args:
            component_path: The component path suffix after /ketos/core/
                           (e.g., "kfx_docling/components/docling/DoclingInlineComponent")
