...
# This allows imports like: import kfx.components.knowledge_bases.retrieval
_redirected_submodules = {
    "kfx.components.knowledge_bases.retrieval": "kfx.components.files_and_knowledge.retrieval",
}
...
def __getattr__(attr_name: str) -> Any:
    ...
    if attr_name == "retrieval":
        ...
        result = import_module("kfx.components.files_and_knowledge.retrieval")
    ...
    package = "kfx.components.files_and_knowledge"
    try:
