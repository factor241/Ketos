...
function fixture(): string {
  // Canonicalize the macOS tmp symlink (`/var` → `/private/var`): Vite
  // realpaths its root, and a non-canonical input path turns the HTML entry
  // into a relative chunk name that escapes the root.
