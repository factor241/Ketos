...
from kfx.base.models.watsonx_constants import WATSONX_MODELS_DETAILED
...
def get_models_detailed() -> list[list[dict]]:
    ...
    When ``kfx.base.models.models_dev_catalog`` has an active snapshot
    ...
    from kfx.base.models.models_dev_catalog import apply_models_dev_overrides, get_active_snapshot
