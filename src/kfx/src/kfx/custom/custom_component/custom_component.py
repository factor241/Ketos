...
from kfx.custom.custom_component.base_component import BaseComponent
from kfx.helpers import (
...
from kfx.services.deps import get_storage_service, get_variable_service, session_scope
from kfx.services.storage.service import StorageService
from kfx.template.utils import update_frontend_node_with_template_values
from kfx.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from kfx.schema.schema import OutputValue
    from kfx.services.storage.service import StorageService
    from kfx.services.tracing.service import TracingService


class CustomComponent(BaseComponent):
    """Represents a custom component in Ketos.
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from kfx.services.deps import get_tracing_service
