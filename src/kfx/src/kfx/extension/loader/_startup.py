...
from kfx.extension.loader._orchestrator import load_extension
from kfx.extension.loader._plugins import _resolve_distribution_roots
from kfx.extension.loader._types import SLOT_OFFICIAL, LoadResult
...
def load_installed_extensions(
    ...
    both land at @official under ``_kfx_ext.official.<name>.*`` and silently
    ...
    *,
    ...
    Args:
        ...
        default_seed_dir: Test seam.  ``None`` uses the discovery layer's
            default (``/opt/ketos/bundles``); pass an explicit ``Path``
    ...
    Returns:
        ...
        determinism.
    """
    from kfx.extension.discovery import DEFAULT_SEED_DIR, discover_seed_extensions
