...
from ketos_stepflow.translation.schema_mapper import SchemaMapper
...
class TestSchemaMapper:
    ...
    def test_init(self):
        """Test initialization."""
        mapper = SchemaMapper()
        assert "str" in mapper.ketos_to_json_schema
        assert mapper.ketos_to_json_schema["str"] == "string"
