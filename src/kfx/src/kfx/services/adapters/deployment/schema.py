...
from kfx.services.adapters.deployment.payloads import (
    T_ConfigItemData,
    T_ConfigListParams,
    T_ConfigListResult,
    T_DeploymentConfig,
...
from kfx.services.adapters.payload import AdapterPayload
...
class DeploymentType(str, Enum):
    """Core deployment types recognized by KFX contracts.

    **Cross-package coupling** — ketos's ``Deployment`` database model
    (``ketos.services.database.models.deployment.model``) persists this
...
class SnapshotDeploymentBindingUpdate(BaseModel, Generic[T_FlowProviderData]):
    ...
    def validate_operations(self):
        ...
        # add_raw_payloads carry flow-artifact IDs (Ketos domain),
