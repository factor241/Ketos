"""Dependency analysis for Ketos workflows."""

from typing import Any


class DependencyAnalyzer:
    """Analyzes Ketos edges to build step dependency graphs."""

    def build_dependency_graph(self, edges: list[dict[str, Any]]) -> dict[str, list[str]]:
        """Build a dependency graph from Ketos edges.

        Args:
            edges: List of Ketos edge objects
