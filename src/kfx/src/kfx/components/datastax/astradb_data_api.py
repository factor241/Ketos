...
A thin, modern Ketos component that exposes the full document-based
Data API surface of DataStax Astra DB using **only** the ``astrapy`` SDK.

The component inherits :class:`kfx.base.datastax.astradb_base.AstraDBBaseComponent`
...
# those used elsewhere in Ketos for a consistent look.
