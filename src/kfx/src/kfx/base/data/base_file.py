...
from kfx.base.data.storage_utils import get_file_size, parse_storage_path, read_file_bytes
from kfx.custom.custom_component.component import Component
from kfx.io import BoolInput, FileInput, HandleInput, Output, StrInput
