...
Covers:
  ...
  - apply_models_dev_overrides: translates fields, replaces covered providers,
    preserves uncovered providers (IBM WatsonX), passes through Ketos-only
...
def test_apply_overrides_replaces_covered_provider():
    from kfx.base.models.models_dev_catalog import apply_models_dev_overrides
...
def test_get_unified_models_detailed_sorts_provider_lists():
    ...
    """
    from kfx.base.models import models_dev_catalog
    from kfx.base.models.unified_models.model_catalog import get_unified_models_detailed
