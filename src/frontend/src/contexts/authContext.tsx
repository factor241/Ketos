...
export function AuthProvider({ children }): React.ReactElement {
  ...
  function login(
    ...
    cookieManager.set(KETOS_ACCESS_TOKEN, newAccessToken);
    cookieManager.set(KETOS_AUTO_LOGIN_OPTION, autoLogin);
    setLocalStorage(KETOS_ACCESS_TOKEN, newAccessToken);
