...
class TelemetrySettings(BaseModel):
    ...
    """If set to True, Ketos will keep track of each vertex builds (outputs) in the UI for any flow."""
    ...
    <tempdir>/ketos_telemetry_outbox. Each worker process uses an isolated
