...
Документ фиксирует состояние базы после ребрендинга: что проверено, какие базовые проблемы и регрессии были найдены и как закрыты. Проблемы этапов 0–1 закрыты; базовая проблема, найденная аудитом этапа 2, записана ниже и закрыта там же. Документ обновляется по мере обнаружения новых.
...
## Найдено и исправлено на этапе 2
