#!/usr/bin/env python3
"""Diagnostic tool for remote Ketos instances.
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose remote Ketos instance")
    parser.add_argument("--host", required=True, help="Ketos host URL")
    ...
    print(f"🔍 Diagnosing Ketos instance: {args.host}")
    print("=" * 60)
    ...
    if not connectivity_results["reachable"]:
        ...
        print("❌ Health check failed - Ketos may not be running properly")
