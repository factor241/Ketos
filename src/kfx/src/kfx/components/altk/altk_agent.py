...
from kfx.base.models.model_input_constants import MODEL_PROVIDERS_DICT, MODELS_METADATA
from kfx.components.models_and_agents.memory import MemoryComponent
from kfx.inputs.inputs import BoolInput
from kfx.io import DropdownInput, IntInput, Output
...
class ALTKAgentComponent(ALTKBaseAgentComponent):
    ...
    documentation: str = "https://docs.ketos.test/bundles-altk"
    icon = "zap"
    beta = True
    name = "ALTK Agent"
