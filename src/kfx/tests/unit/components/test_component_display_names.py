...
def _discover_all_component_classes() -> list[tuple[str, type]]:
    """Discover all component classes from the kfx.components package.

    Finds all .py files under kfx/components, imports them, and collects
    ...
    components_pkg_path = Path(kfx.components.__path__[0])
    components_pkg_name = kfx.components.__name__
