...
class UiSettings(BaseModel):
    """Frontend, auto-save, display limits, and (legacy) Ketos Store integration."""

    auto_saving: bool = True
    """If set to True, Ketos will auto save flows."""
    auto_saving_interval: int = 1000
    """The interval in ms at which Ketos will auto save flows."""
    ...
    store_url: str | None = "https://api.ketos.store"
    download_webhook_url: str | None = "https://api.ketos.store/flows/trigger/ec611a61-8460-4438-b187-a4f65e5559d4"
    like_webhook_url: str | None = "https://api.ketos.store/flows/trigger/64275852-ec00-45c1-984e-3bff814732da"
