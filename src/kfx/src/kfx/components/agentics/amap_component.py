...
from kfx.components.agentics.helpers import (
    build_schema_fields,
    prepare_llm_from_component,
)
from kfx.components.agentics.inputs import (
    get_generated_fields_input,
    get_model_provider_inputs,
)
from kfx.components.agentics.inputs.base_component import BaseAgenticComponent
from kfx.io import (
    BoolInput,
    DataFrameInput,
    MessageTextInput,
...
class AMapComponent(BaseAgenticComponent):
    ...
    documentation: str = "https://docs.ketos.test/bundles-agentics"
    icon = "Agentics"
