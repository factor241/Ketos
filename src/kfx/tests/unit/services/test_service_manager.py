...
from kfx.services.manager import NoFactoryRegisteredError, ServiceManager
...
class TestPluginDiscovery:
    ...
    def test_discover_storage_from_config_file(self, service_manager, temp_config_dir):
        """Test discovering LocalStorageService from kfx.toml."""
        config_file = temp_config_dir / "kfx.toml"
...
[services]
storage_service = "kfx.services.storage.local:LocalStorageService"
telemetry_service = "kfx.services.telemetry.service:TelemetryService"
tracing_service = "kfx.services.tracing.service:TracingService"
variable_service = "kfx.services.variable.service:VariableService"
"""
        )
...
"""
    ...
    def test_kfx_toml_takes_precedence_over_pyproject(self, service_manager, temp_config_dir):
        """Test that kfx.toml is preferred over pyproject.toml."""
        # Create both files
        (temp_config_dir / "kfx.toml").write_text(
            """
[services]
storage_service = "kfx.services.storage.local:LocalStorageService"
"""
...
"""
        ...
        # Should have loaded from kfx.toml (storage_service)
        assert ServiceType.STORAGE_SERVICE in service_manager.service_classes
