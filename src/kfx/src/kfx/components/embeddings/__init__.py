...
if TYPE_CHECKING:
    from kfx.components.embeddings.similarity import EmbeddingSimilarityComponent
    from kfx.components.embeddings.text_embedder import TextEmbedderComponent
