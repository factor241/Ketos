...
# langchain-ibm / ibm-watsonx-ai are real runtime deps of the kfx-ibm bundle,
...
# with a MagicMock so the kfx workspace venv (which did not pull
...
# import path, e.g. ``@patch("kfx_ibm.components.ibm.watsonx.ChatWatsonx")``.
...
class TestWatsonxAIComponent:
    ...
    @patch("kfx_ibm.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    ...
    @patch("kfx_ibm.components.ibm.watsonx.ChatWatsonx")
    ...
    @patch("kfx_ibm.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    @patch("kfx_ibm.components.ibm.watsonx.logger")
