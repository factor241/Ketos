...
from ketos.api.schemas import UploadFileResponse
from ketos.api.utils import CurrentActiveUser, DbSession, build_content_disposition
from ketos.services.authorization import FileAction, ensure_file_permission
...
async def download_files_batch(
    ...
    try:
        ...
        filename = f"{current_time}_ketos_files.zip"
