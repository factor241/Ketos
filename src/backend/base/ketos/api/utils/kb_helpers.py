...
from kfx.base.knowledge_bases.ingestion_sources.base import IngestionItemStatus, IngestionRunStatus
from kfx.base.vectorstores.chroma_security import chroma_langchain_collection_kwargs
from kfx.components.models_and_agents.embedding_model import EmbeddingModelComponent
from kfx.log import logger

from ketos.api.utils import CurrentActiveUser
...
class KBIngestionHelper:
    ...
    async def perform_ingestion(
        ...
        CANCELLED.
        """
        # Lazy import: the service reaches into ketos DB plumbing we
        # can't expose at module scope without widening kfx's surface.
        from ketos.api.utils import ingestion_run_service, knowledge_base_service
        from ketos.api.utils.knowledge_base_service import (
            get_embedding_model,
        ...
        try:
            ...
            backend = create_backend(
                ...
                # pull their connection URI / tokens from Ketos's
    ...
    async def build_embeddings(provider: str, model: str, current_user):
        ...
        """
        from kfx.base.models.unified_models.class_registry import (
        ...
        # configured). See https://github.com/ketos-ai/ketos/issues/13883.
