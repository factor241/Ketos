...
from ketos.api.disconnect import DisconnectHandlerStreamingResponse
...
from ketos.schema.message import ErrorMessage
from ketos.schema.schema import OutputValue
        ...
        if event_delivery != EventDeliveryType.POLLING:
            ...
            raise HTTPException(
                ...
                detail=(
                    ...
                    "set KETOS_EVENT_DELIVERY to override the default."
                ),
            )
