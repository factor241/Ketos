...
from kfx.graph.flow_builder.spec import parse_flow_spec, validate_spec_references
...
def load_local_registry() -> dict[str, dict]:
    ...
    try:
        ...
        msg = f"Component registry not found at {_INDEX_PATH}. The kfx package may be installed incorrectly."
