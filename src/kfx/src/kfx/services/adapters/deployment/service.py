...
from kfx.services.adapters.deployment.exceptions import DeploymentNotConfiguredError
...
# testable.  Concrete adapters (e.g. in Ketos) subclass BaseDeploymentService
# and register under meaningful keys like "local" or "remote".
class DeploymentService(BaseDeploymentService):
    """Null deployment service for KFX.

    All operations raise :class:`DeploymentNotConfiguredError` because KFX does
    not ship a deployment adapter.  Concrete adapters (e.g. in Ketos) should
