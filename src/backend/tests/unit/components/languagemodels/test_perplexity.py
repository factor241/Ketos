...
import pytest
from kfx.components.perplexity.perplexity import PerplexityComponent
from kfx.custom.custom_component.component import Component
from kfx.custom.utils import build_custom_component_template
from kfx.inputs.inputs import DropdownInput, FloatInput, IntInput, SecretStrInput, SliderInput
...
class TestPerplexityComponent(ComponentTestBaseWithoutClient):
    ...
    def test_build_model(self, component_class, default_kwargs, mocker):
        ...
        mock_chat = mocker.patch("kfx.components.perplexity.perplexity.ChatPerplexity", return_value=MagicMock())
