"""Unit tests for the shared flow-envelope helpers (kfx.utils.flow_envelope).

These back the outer-envelope handling used by `kfx run`, `kfx serve`, `kfx upgrade`, and the
