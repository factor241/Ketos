...
from kfx.base.models.model_input_constants import (
    ALL_PROVIDER_FIELDS,
...
from kfx.custom.custom_component.component import _get_component_toolkit
from kfx.custom.utils import update_component_build_config
from kfx.field_typing import Tool
from kfx.io import BoolInput, DropdownInput, IntInput, MultilineInput, Output
from kfx.log.logger import logger
from kfx.schema.dotdict import dotdict
from kfx.schema.message import Message

if TYPE_CHECKING:
    from kfx.schema.log import SendMessageFunctionType
...
_CUGA_CODE_AGENT_GUARD_ATTR = "_ketos_code_agent_guard_installed"
...
class CugaComponent(ToolCallingAgentComponent):
    ...
    documentation: str = "https://docs.ketos.test/bundles-cuga"
    icon = "bot"
    name = "Cuga"
    ...
    async def message_response(self) -> Message:
        ...
        try:
            ...
            from kfx.schema.message import MESSAGE_SENDER_AI
            ...
            from kfx.base.agents.events import process_agent_events
