...
from kfx.base.data.docling_utils import extract_docling_documents
from kfx.custom import Component
from kfx.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, Output, StrInput
from kfx.schema import Data, DataFrame

_CHUNKING_INSTALL_HINT = (
    "Install them with `uv pip install 'kfx-docling[chunking]'`, "
    "`uv pip install 'ketos[docling-chunking]'`, or "
