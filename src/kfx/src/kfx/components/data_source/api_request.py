...
from kfx.base.curl.parse import parse_context
from kfx.custom.custom_component.component import Component
from kfx.inputs.inputs import TabInput
from kfx.io import (
    BoolInput,
    DataInput,
    DropdownInput,
...
from kfx.utils.component_utils import set_current_fields, set_field_advanced, set_field_display
...
class APIRequestComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/api-request"
    icon = "Globe"
    name = "APIRequest"
    ...
    inputs = [
        ...
        TableInput(
            ...
            value=[{"key": "User-Agent", "value": "Ketos/1.0"}],
            advanced=True,
            input_types=["Data", "JSON"],
            real_time_refresh=True,
        ),
