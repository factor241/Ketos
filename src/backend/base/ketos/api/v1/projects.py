...
from ketos.api.v1.mappers.deployments.sync import (
    retry_flow_operation_on_deployment_guard,
    retry_project_operation_on_deployment_guard,
)
from ketos.api.v1.mcp_projects import register_project_with_composer
from ketos.api.v1.projects_files import download_project_flows, upload_project_flows
from ketos.api.v1.projects_mcp_helpers import (
...
from ketos.services.database.models.deployment.guards import check_project_has_deployments
from ketos.services.database.models.deployment.orm_guards import ensure_flow_moves_allowed
from ketos.services.database.models.flow.model import Flow, FlowRead
from ketos.services.database.models.folder.constants import DEFAULT_FOLDER_NAME, DEFAULT_FOLDER_NAME_I18N_KEY
from ketos.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from ketos.services.database.models.folder.pagination_model import FolderWithPaginatedFlows
from ketos.services.deps import get_service, get_settings_service
from ketos.services.schema import ServiceType
from ketos.utils.i18n import translate
...
async def delete_project(
    *,
    ...
    # Prevent deletion of the Ketos Assistant folder
