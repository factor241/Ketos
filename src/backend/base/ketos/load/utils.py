import httpx
from kfx.load.utils import UploadError, replace_tweaks_with_env, upload, upload_file

from ketos.services.database.models.flow.model import FlowBase
...
def get_flow(url: str, flow_id: str):
    """Get the details of a flow from Ketos.

    Args:
        url (str): The host URL of Ketos.
