...
from kfx.base.prompts.utils import dict_values_to_string
from kfx.log.logger import logger
from kfx.schema.content_block import ContentBlock
from kfx.schema.content_types import ErrorContent
from kfx.schema.data import Data
from kfx.schema.image import Image, get_file_paths, is_image_file
from kfx.schema.properties import Properties, Source
from kfx.schema.validators import timestamp_to_str, timestamp_to_str_validator
from kfx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from kfx.utils.image import create_image_content_dict
from kfx.utils.mustache_security import safe_mustache_render
from kfx.utils.secrets import is_secret_value
...
def _is_text_like_extension(file_path: Any) -> bool:
    ...
    """
    from kfx.base.data.utils import TEXT_FILE_TYPES
...
class Message(Data):
    ...
    def get_file_content_dicts(self, model_name: str | None = None):
        ...
        for file in files:
            ...
            try:
                ...
                from kfx.base.data.utils import parse_text_file_to_data
    ...
    def to_dataframe(self) -> DataFrame:
        from kfx.schema.dataframe import DataFrame  # Local import to avoid circular import
