...
from kfx.schema.openai_responses_schemas import create_openai_error, create_openai_error_chunk
...
from ketos.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
...
from ketos.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from ketos.schema.content_types import ToolContent
...
from ketos.services.deps import get_telemetry_service
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Ketos events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Ketos flow.
    ...
    # Extract global variables from X-KETOS-GLOBAL-VAR-* headers
