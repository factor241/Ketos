...
from kfx.inputs.inputs import BoolInput, DropdownInput, FloatInput, IntInput, MessageTextInput, SecretStrInput
...
class NvidiaIngestComponent(BaseFileComponent):
    ...
    try:
        ...
        msg = (
            ...
            "Install with `uv pip install 'ketos[nv-ingest]'` "
    ...
    def process_files(self, file_list: list[BaseFileComponent.BaseFile]) -> list[BaseFileComponent.BaseFile]:
        try:
            ...
            msg = (
                ...
                "Please install them using your package manager. (e.g. uv pip install ketos[nv-ingest])"
            )
