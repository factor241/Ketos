...
def _get_version_info():
    ...
    package_options = [
        ("ketos", "Ketos"),
        ("ketos-base", "Ketos Base"),
        ("ketos-nightly", "Ketos Nightly"),
        ("ketos-base-nightly", "Ketos Base Nightly"),
    ]
    __version__ = None
    for pkg_name, display_name in package_options:
        try:
            ...
            # The canonical `ketos` / `ketos-base` distribution matches first, and the
