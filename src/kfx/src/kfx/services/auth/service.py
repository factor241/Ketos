"""Default auth service for KFX (no database/JWT; use Ketos auth for full auth)."""
...
class AuthService(BaseAuthService):
    """Default KFX auth service.

    No database, JWT, or API key validation. For full auth, configure
    auth_service = "ketos.services.auth.service:AuthService" in kfx.toml.
    """
