...
if TYPE_CHECKING:
    from kfx.components.codeagents.codeact_agent_smolagents import CodeActAgentSmolagentsComponent
    from kfx.components.codeagents.open_ds_star_agent import OpenDsStarAgentComponent
