...
from ketos.api.utils import CurrentActiveUser, check_ketos_version
from ketos.services.auth import utils as auth_utils
from ketos.services.deps import get_settings_service, get_store_service
from ketos.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_ketos_version(component)
