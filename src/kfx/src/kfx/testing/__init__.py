"""pytest plugin providing flow_runner fixtures for local Ketos flow execution.
...
environment variables::
    ...
    pytest --kfx-env-file .env --kfx-timeout 60 tests/

Per-test overrides via markers::

    @pytest.mark.kfx_env_file(".env.test")
    @pytest.mark.kfx_timeout(30)
...
from kfx.testing.plugin import (
    _SKIP_NO_REMOTE,
    _get_marker_arg,
