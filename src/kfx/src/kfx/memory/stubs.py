"""Memory management functions for kfx package.

This module provides message storage and retrieval functionality adapted for kfx's
service-based architecture. It mirrors the ketos.memory API but works with
kfx's Message model and service interfaces.
"""
...
async def astore_message(
    ...
    # In kfx, we use the service architecture - this is a simplified implementation
    ...
    async with session_scope() as session:
        ...
        # but maintains the same interface as ketos.memory
        try:
