...
- "generate_component": User wants you to CREATE/BUILD/GENERATE/MODIFY a custom Ketos component.
...
- "question": User is ASKING A QUESTION about Ketos, seeking help with Ketos, wants \
information about Ketos features/components/flows, OR is just being conversational \
...
- "off_topic": The request is NOT about Ketos AND is not a social pleasantry. It is a \
SUBSTANTIVE question/task about other tools, platforms, or general knowledge unrelated to Ketos.
...
"question" (answer it briefly and warmly). off_topic is ONLY for substantive non-Ketos topics.

IMPORTANT rules:
- "How to create a component" = question (asking for Ketos guidance)
...
- General knowledge questions NOT related to Ketos = off_topic
...
- If unsure whether it's about Ketos, classify as "question" (not off_topic)
...
- "how do I create a file?" / "how to save files in Ketos" = question (asking for guidance)
...
Examples:
Input: "como criar um componente no ketos"
Output: {{"translation": "how to create a component in ketos", "intent": "question"}}
...
Input: "how do I save a file in Ketos?"
Output: {{"translation": "how do I save a file in Ketos?", "intent": "question"}}
