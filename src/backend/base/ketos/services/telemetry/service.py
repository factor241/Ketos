...
from ketos.services.telemetry.opentelemetry import OpenTelemetry
...
class TelemetryService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        self.common_telemetry_fields = {
            ...
            "platform": "desktop" if self._get_ketos_desktop() else "python_package",
    ...
    async def _send_email_telemetry(self) -> None:
        ...
        from ketos.utils.registered_email_util import get_email_model
