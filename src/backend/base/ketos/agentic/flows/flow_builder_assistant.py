"""FlowBuilderAssistant - Builds Ketos flows using component discovery tools.
...
from ketos.agentic.services.file_events import wrap_file_tool_with_event

FLOW_BUILDER_PROMPT = """\
You are a Ketos Flow Builder assistant. You build and modify flows directly \
