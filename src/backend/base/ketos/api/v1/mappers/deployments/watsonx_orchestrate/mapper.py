...
from kfx.services.adapters.payload import (
    AdapterPayload,
...
from ketos.api.v1.mappers.deployments.registry import register_mapper
...
class WatsonxOrchestrateDeploymentMapper(BaseDeploymentMapper):
    ...
    def resolve_deployment_model_for_create(
        ...
        *,
        ...
        adapter_provider_result = self.parse_adapter_slot(
            ...
            operation="creating the deployment row in Ketos",
        )
        return Deployment(
            user_id=user_id,
    ...
    def resolve_deployment_model_from_existing_resource_for_create(
        ...
        *,
        ...
        existing_provider_data = self.parse_adapter_slot(
            ...
            operation="reading deployment metadata from provider when attempting to track the resource in Ketos",
        )
        return Deployment(
            user_id=user_id,
            project_id=project_id,
    ...
    async def resolve_rollback_update(
        ...
        *,
        ...
        """
        from ketos.services.database.models.deployment.crud import get_deployment
        from ketos.services.database.models.flow_version_deployment_attachment.crud import (
        ...
        # and include it here so rollback can restore wxO `name` from Ketos's stored metadata.
