...
def test_openrouter_in_provider_registry():
    from kfx.base.models.model_metadata import LIVE_MODEL_PROVIDERS, MODEL_PROVIDER_METADATA
...
def test_openrouter_metadata_shape():
    from kfx.base.models.model_metadata import MODEL_PROVIDER_METADATA
...
def test_openrouter_appears_in_get_model_providers():
    from kfx.base.models.unified_models import get_model_providers
...
def test_fetch_live_openrouter_models_returns_empty_for_embeddings():
    from kfx.base.models.model_utils import fetch_live_openrouter_models
...
def test_fetch_live_openrouter_models_defaults_intersect_with_seed_list():
    ...
    """
    from kfx.base.models import model_utils
    from kfx.base.models.openrouter_constants import OPENROUTER_MODELS_DETAILED
...
def test_fetch_live_openrouter_models_defaults_fall_back_when_no_seed_overlap():
    ...
    """
    from kfx.base.models import model_utils
    from kfx.base.models.model_utils import MIN_DEFAULT_MODELS
...
def test_validate_openrouter_no_key_returns_silently():
    from kfx.base.models.unified_models import validate_model_provider_key
...
def test_validate_provider_uses_requested_model_name():
    ...
    with (
        ...
        patch("kfx.base.models.unified_models.model_catalog.get_unified_models_detailed", return_value=catalog),
    ):
...
def test_get_llm_for_openrouter_sets_base_url_and_headers():
    from kfx.base.models import unified_models as unified_models_module
