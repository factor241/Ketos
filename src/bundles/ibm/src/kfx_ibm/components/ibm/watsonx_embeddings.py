...
from kfx.base.models.model_utils import get_watsonx_embedding_models
from kfx.field_typing import Embeddings
from kfx.io import BoolInput, DropdownInput, IntInput, Output, SecretStrInput, StrInput
...
class WatsonxEmbeddingsComponent(LCEmbeddingsModel):
    """KFX component for IBM watsonx.ai embeddings."""
