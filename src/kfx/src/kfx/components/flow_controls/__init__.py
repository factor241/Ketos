...
if TYPE_CHECKING:
    ...
    from kfx.components.flow_controls.loop import LoopComponent
    from kfx.components.flow_controls.notify import NotifyComponent
    from kfx.components.flow_controls.pass_message import PassMessageComponent
    from kfx.components.flow_controls.run_flow import RunFlowComponent
    from kfx.components.flow_controls.sub_flow import SubFlowComponent
