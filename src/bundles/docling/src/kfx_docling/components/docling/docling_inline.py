...
from kfx.base.data import BaseFileComponent
from kfx.base.data.docling_utils import _serialize_pydantic_model
from kfx.inputs import BoolInput, DropdownInput, HandleInput, StrInput
...
class DoclingInlineComponent(BaseFileComponent):
                        ...
                        try:
                            ...
                            print(json.dumps({
                                ...
                                "error": (
                                    ...
                                    "`uv pip install 'ketos[docling-image-description]'` or "
    ...
    def process_files(self, file_list: list[BaseFileComponent.BaseFile]) -> list[BaseFileComponent.BaseFile]:
        ...
        if importlib.util.find_spec("docling") is None:
            msg = (
                "Docling is an optional dependency. Install with `uv pip install 'ketos[docling]'` or "
