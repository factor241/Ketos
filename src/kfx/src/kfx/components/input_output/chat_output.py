...
from kfx.base.io.chat import ChatComponent
from kfx.helpers.data import safe_convert
from kfx.inputs.inputs import BoolInput, DropdownInput, HandleInput, MessageTextInput
from kfx.schema.data import Data
from kfx.schema.dataframe import DataFrame
from kfx.schema.message import Message
from kfx.schema.properties import Source
from kfx.template.field.base import Output
from kfx.utils.constants import (
    MESSAGE_SENDER_AI,
...
class ChatOutput(ChatComponent):
    ...
    documentation: str = "https://docs.ketos.test/chat-input-and-output"
    icon = "MessagesSquare"
    name = "ChatOutput"
    minimized = True
