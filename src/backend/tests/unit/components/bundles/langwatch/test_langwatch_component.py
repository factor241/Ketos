...
from kfx.base.langwatch.utils import get_cached_evaluators
from kfx.components.langwatch.langwatch import LangWatchComponent
...
class TestLangWatchComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("kfx.components.langwatch.langwatch.httpx.get")
