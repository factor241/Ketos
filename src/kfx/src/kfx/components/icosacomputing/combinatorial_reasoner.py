...
from kfx.base.models.openai_constants import OPENAI_CHAT_MODEL_NAMES
from kfx.custom.custom_component.component import Component
from kfx.inputs.inputs import DropdownInput, SecretStrInput, StrInput
...
class CombinatorialReasonerComponent(Component):
    ...
    def build_prompt(self) -> Message:
        ...
        response = requests.post(
            "https://cr-api.icosacomputing.com/cr/ketos",
            json=params,
            auth=creds,
            timeout=100,
        )
