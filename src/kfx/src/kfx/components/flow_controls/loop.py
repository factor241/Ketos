from kfx.base.flow_controls.loop_utils import (
    execute_loop_body,
    extract_loop_output,
...
from kfx.components.processing.converter import convert_to_data
from kfx.custom.custom_component.component import Component
from kfx.inputs.inputs import HandleInput
...
class LoopComponent(Component):
    ...
    documentation: str = "https://docs.ketos.test/loop"
    icon = "infinity"
