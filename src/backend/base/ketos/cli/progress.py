...
def create_ketos_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Ketos initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Ketos", "Setting up basic configuration"),
        ...
        ("Launching Ketos", "Starting server and final setup"),
    ]
...
def create_ketos_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Ketos shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
