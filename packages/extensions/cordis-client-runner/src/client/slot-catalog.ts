...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Root container of the spatial board canvas.',
    doc: 'Root container of the spatial board canvas.',
    registerOptions: [],
    ownerProps: [],
  ...
  },
  {
    ...
    doc: 'Window container for a single board card.',
    registerOptions: [
      {
        name: 'key',
    ...
    keyDomain: 'fixed by the owner\'s key table { [key: string]: BoardWindowOwnerProps }, none are taken yet',
    hookContext: '',
    slotInject: '',
    declaredBy: 'the runtime itself (built in; always present)',
    occupants: [],
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Multi-window layer rendering individual cards and dialogs.',
    doc: 'Multi-window layer rendering individual cards and dialogs.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
