"""Semantic validation checks for Ketos flow JSON.
...
# ---------------------------------------------------------------------------
# Level 2 - component existence (loads kfx component registry)
# ---------------------------------------------------------------------------


def _check_component_existence(flow: dict[str, Any], result: ValidationResult) -> None:
    try:
        from kfx.interface.utils import initialize_components  # type: ignore[import-untyped]
