...
from kfx.io import BoolInput, HandleInput, IntInput, StrInput
...
class FaissVectorStoreComponent(LCVectorStoreComponent):
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Path to save the FAISS index. It will be relative to where Ketos is running.",
        ),
    ...
    def resolve_path(path: str) -> str:
        """Resolve the path relative to the Ketos root.
    ...
    def get_persist_directory(self) -> Path:
        ...
        if user_scope := self._user_scope(self.user_id):
            return path / ".ketos_faiss" / "users" / user_scope
        return path
