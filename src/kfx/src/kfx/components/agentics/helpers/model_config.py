...
from kfx.components.agentics.constants import (
...
# kfx.base.models.unified_models, which centralises provider-field show/hide
...
def update_provider_fields_visibility(
    ...
    """Deprecated. Use handle_model_input_update() from kfx.base.models.unified_models instead.
    ...
    warnings.warn(
        ...
        "Use handle_model_input_update() from kfx.base.models.unified_models instead.",
        DeprecationWarning,
        stacklevel=2,
    )
