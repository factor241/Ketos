...
from ketos.api.utils import CurrentActiveUser, DbSession, extract_global_variables_from_headers, parse_value
from ketos.api.v1.files import get_flow
from ketos.api.v1.global_variable_defaults import apply_global_variable_defaults
...
from ketos.events.event_manager import create_stream_tokens_event_manager
from ketos.exceptions.api import APIException, InvalidChatInputError
from ketos.exceptions.serialization import SerializationError
from ketos.helpers.flow import get_flow_by_id_or_endpoint_name
from ketos.interface.initialize.loading import update_params_with_load_from_db_fields
from ketos.processing.process import process_tweaks, run_graph_internal
from ketos.schema.graph import Tweaks
from ketos.services.auth.utils import (
    api_key_security,
    get_current_active_user,
    get_current_user_for_sse,
    get_optional_user,
)
from ketos.services.authorization import FlowAction, ensure_flow_permission
from ketos.services.cache.utils import save_uploaded_file
from ketos.services.database.models.flow.model import Flow, FlowRead
from ketos.services.database.models.flow.utils import get_all_webhook_components_in_flow
...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-KETOS-GLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-KETOS-GLOBAL-VAR-*
...
# get endpoint to return version of ketos
@router.get("/version")
...
async def custom_component(
    ...
    locale = getattr(request.state, "locale", "en")
    if locale != "en":
        from ketos.utils.i18n import is_user_custom_component_node, translate_component_node
