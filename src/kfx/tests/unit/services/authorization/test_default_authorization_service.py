"""Tests for the default KFX AuthorizationService (no-op allow-all implementation)."""
...
async def test_is_enabled_returns_false(service: AuthorizationService) -> None:
    """The KFX default reports authorization as disabled."""
...
async def test_invalidate_user_is_noop(service: AuthorizationService) -> None:
    """Cache invalidation hooks are no-ops on the default KFX implementation."""
