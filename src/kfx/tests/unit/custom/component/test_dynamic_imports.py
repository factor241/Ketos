"""Tests for dynamic import refactor in ketos components.
...
class TestImportUtils:
    ...
    def test_import_mod_module_not_found(self):
        ...
        with pytest.raises(ImportError, match="not found"):
            import_mod("NonExistentComponent", "nonexistent_module", "kfx.components.openai")
    ...
    def test_import_mod_attribute_not_found(self):
        ...
        with pytest.raises(ModuleNotFoundError, match="No module named"):
            import_mod("NonExistentComponent", "openai_chat_model", "kfx.components.openai")
...
class TestComponentDynamicImports:
    ...
    def test_multiple_category_modules(self):
        ...
        import kfx.components.anthropic as anthropic_components
        import kfx.components.data as data_components
    ...
    def test_backward_compatibility(self):
        ...
        # These imports should work since ketos is installed with dependencies
        ...
        from kfx.components import data
    ...
    def test_import_error_handling(self):
        ...
        import kfx.components.notdiamond as notdiamond_components

        # Patch the import_mod function directly
        with patch("kfx.components.notdiamond.import_mod") as mock_import_mod:
    ...
    def test_type_checking_imports(self):
        ...
        import kfx.components.searchapi as searchapi_components
...
class TestPerformanceCharacteristics:
    ...
    def test_lazy_loading_performance(self):
        ...
        from kfx.components import chroma as chromamodules
...
class TestSpecialCases:
    ...
    def test_platform_specific_components(self):
        ...
        import kfx.components.nvidia as nvidia_components
